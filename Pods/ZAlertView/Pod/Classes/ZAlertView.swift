...
@objc public class ZAlertView: UIViewController {
    ...
    public static var textFieldBorderColor: UIColor?     = UIColor(red: 31/255, green: 78/255, blue: 121/255, alpha: 1.0)
    ...
    func setupViews() {
        ...
        self.alertView.backgroundColor    = UIColor(red: 198/255, green: 215/255, blue: 238/255, alpha: 1.0)
        self.alertView.layer.borderColor = UIColor(red: 31/255, green: 78/255, blue: 121/255, alpha: 1.0).CGColor
        ...
        self.btnOk.layer.borderColor = UIColor(red: 31/255, green: 78/255, blue: 121/255, alpha: 1.0).CGColor
        ...
        self.btnCancel.layer.borderColor = UIColor(red: 31/255, green: 78/255, blue: 121/255, alpha: 1.0).CGColor
